...
Scaffold Success() {
  return Scaffold(
    ...
    backgroundColor: const Color.fromARGB(255, 243, 241, 224),
    appBar: AppBar(
      title: Text(
        'Mayo 16',
      ...
      actions: [
        ...
        IconButton(
          iconSize: 30.0,
          color: Color.fromARGB(255, 248, 240, 210),
        ...
        IconButton(
          iconSize: 40,
          color: Color.fromARGB(255, 255, 246, 214),
    ...
    floatingActionButton: FloatingActionButton(
      backgroundColor: const Color.fromARGB(255, 239, 232, 201),
      onPressed: () {},
